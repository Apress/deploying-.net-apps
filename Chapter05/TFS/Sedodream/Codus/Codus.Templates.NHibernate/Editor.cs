...
namespace Codus.Templates.Adapdev
{
	...
	public class Editor : Codus.GUI.Extensions.GUIConfigurator
	{
		...
		private void InitializeComponent()
		{
			...
			// cbWebServices
			// 
			this.cbWebServices.Location = new System.Drawing.Point(224, 40);
			...
			this.cbWebServices.Visible = false;
			// 
			// cbZanebug
			// 
		...
		public override string PostMessage
		{
			get
			{
				return "IMPORTANT: After compiling, you must copy the nHibernate *.hbm.xml mapping files, located in the /Mappings directory, to your build directory prior to running any tests or code. " +
					"The code won't work unless the mapping files are in the same location as the executables.";
			}
		}
