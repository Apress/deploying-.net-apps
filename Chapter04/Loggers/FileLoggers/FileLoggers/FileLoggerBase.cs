...
namespace FileLoggers
{
    ...
    {
        /// <summary>
        /// Verbosity to be used for this logger
        /// </summary>
        protected LoggerVerbosity _verbosity;
        /// <summary>
        ...
        public override void Initialize(IEventSource eventSource)
        {
            ...
            {
                throw new LoggerException("Unable to initalize the logger", e);
            }
        }
        /// <summary>
        ...
        protected void InitalizeParameters()
        {
            ...
            {
                throw new LoggerException("Unable to initalize parameterss; message=" + e.Message,e);
            }
        }
        /// <summary>
        ...
        protected void ProcessVerbosity(string level)
        {
            ...
            //catch (Exception e)
            //{
            //    //throw new LoggerException("Unable to process the verbosity", e);
            //}
        ...
        protected void ProcessAppend(string appendStr)
        {
            try
            {
        ...
        /// </summary>
        protected ICollection<string> DefiniedParameters
        {
            get
            {
                if (this._paramaterBag == null)
                {
                    return null;
                }

                return this._paramaterBag.Keys;
            }
        }
    }
}